...
class CarRegisterWindow(QWidget):
    ...
    def init_ui(self):
        ...
        menu_label.setStyleSheet("font-size: 18px; font-weight: bold; color: #555;")
        ...
        back_to_home_btn.setStyleSheet("padding: 10px; background-color: #f44336; color: white; border-radius: 5px; font-size: 16px;")
        ...
        self.vehicles_list.setStyleSheet("font-size: 16px; color: #333; background-color: #f9f9f9; border: 1px solid #ddd;")
        ...
        self.edit_vehicle_btn.setStyleSheet("padding: 10px; background-color: #2196F3; color: white; border-radius: 5px; font-size: 16px;")
        ...
        self.delete_vehicle_btn.setStyleSheet("padding: 10px; background-color: #f44336; color: white; border-radius: 5px; font-size: 16px;")
        ...
        back_to_menu_btn.setStyleSheet("padding: 10px; background-color: #4CAF50; color: white; border-radius: 5px; font-size: 16px;")
        ...
        register_button.setStyleSheet("padding: 10px; background-color: #4CAF50; color: white; border-radius: 5px; font-size: 16px;")
        register_button.clicked.connect(self.register_vehicle)
        cancel_button = QPushButton("Cancelar")
        cancel_button.setStyleSheet("padding: 10px; background-color: #f44336; color: white; border-radius: 5px; font-size: 16px;")
        ...
        send_request_button.setStyleSheet("padding: 10px; background-color: #4CAF50; color: white; border-radius: 5px; font-size: 16px;")
        send_request_button.clicked.connect(self.send_vehicle_share_request)
        back_button = QPushButton("Voltar")
        back_button.setStyleSheet("padding: 10px; background-color: #f44336; color: white; border-radius: 5px; font-size: 16px;")
